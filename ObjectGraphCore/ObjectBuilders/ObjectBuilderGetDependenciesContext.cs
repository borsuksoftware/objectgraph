...
namespace BorsukSoftware.ObjectGraph.ObjectBuilders
{
	...
	public class ObjectBuilderGetDependenciesContext<TAddress> : IObjectBuilderGetDependenciesContext<TAddress>
	{
		#region Data Model
		...
		public ObjectBuilderGetDependenciesContext( IObjectContext<TAddress> objectContext )
		{
